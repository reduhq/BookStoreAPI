...
from bookstore.tests.utils.user import random_email, random_lower_string
...
async def test_get_users_superuser_me(
    ...
    assert current_user["role"] is not Role.reader.value
    assert current_user["role"] is not Role.writer.value
...
async def test_get_users_normal_user_me(
    ...
    current_user = r.json()
    assert current_user["role"] != Role.admin.value
    assert current_user["role"] != Role.reader.value
    assert current_user["role"] == Role.writer.value
